...
public class RemoteTcpMuleClientFunctionalTestCase extends FunctionalTestCase
{
    ...
    public void testTickerLookup() throws Exception
    {
        ...
        final RemoteDispatcher remoteDispatcher = muleClient.getRemoteDispatcher("tcp://localhost:5555");

        final FutureMessageResult asyncResponse = remoteDispatcher.sendAsyncRemote("TickerLookupChannel",
            "NASDAQ:GOOG", null);
        ...
        final String response = asyncResponse.getMessage(10000).getPayloadAsString();
