...
After Mule is started, navigate to the HTML Dashboard: http://localhost:8080/dashboard


You can fiddle with the Ping service at: http://localhost:8080/ping


Then HTTP POST the sample data file in /data to localhost:8080/publicationService
